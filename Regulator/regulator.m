...
ID = 'R'; %identyfikator uzytkownika: E- elektrocieplowania, W- Wymiennik, R- Regulator, B- budynek
%nowa wersja matlaba
t = tcpip(IP, PORT_NUMBER,'NetworkRole', 'client'); 

   Data=sprintf('%+09.4f',Fzm); %R
...
while(1)
    ...
    while(wait)
        ...
        pause(2); % okres co jaki wysyłana jest kolejna komenda keepalive
    end
